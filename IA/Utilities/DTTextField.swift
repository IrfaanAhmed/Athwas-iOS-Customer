...
public class DTTextField: UITextField {
    ...
    fileprivate let paddingX:CGFloat                        = 12.0
    ...
    public var dtborderStyle:DTBorderStyle = .rounded{
        didSet{
            ...
            case .rounded:
                ...
                dtLayer.borderWidth         = textBorderWidth
                dtLayer.borderColor         = textBorderColor.cgColor
            case .sqare:
                dtLayer.cornerRadius        = 0.0
                dtLayer.borderWidth         = textBorderWidth
                dtLayer.borderColor         = textBorderColor.cgColor
            case .bottom,.left,.right,.top:
                dtLayer.cornerRadius        = 0.0
                dtLayer.borderWidth         = 0.0
                borderLayer.backgroundColor = textBorderColor.cgColor
                if dtborderStyle == .bottom {
                    borderLayer.frame = CGRect(x: 0, y: dtLayer.bounds.size.height - textBorderWidth, width: dtLayer.bounds.size.width, height: borderWidth)
                }else if dtborderStyle == .left{
                    borderLayer.frame = CGRect(x: 0, y: 0, width: textBorderWidth, height: dtLayer.bounds.size.height)
                }else if dtborderStyle == .right{
                    borderLayer.frame = CGRect(x: dtLayer.bounds.size.width - textBorderWidth, y: 0, width: borderWidth, height: dtLayer.bounds.size.height)
                }else{
                    borderLayer.frame = CGRect(x: 0, y: 0, width: dtLayer.bounds.size.width, height: textBorderWidth)
                }
    ...
    public var textBorderColor:UIColor = UIColor(red: 204.0/255.0, green: 204.0/255.0, blue: 204.0/255.0, alpha: 1.0) {
        didSet{
            switch dtborderStyle {
    ...
    fileprivate func commonInit() {
        ...
        floatPlaceholderActiveColor = .clear
    ...
    @objc fileprivate func textFieldTextChanged(){
        ...
        showErrorLabel = false
        self.textBorderColor = .lightGray
    }
